...
- **Oracle manipulation.** The BME loop depends on the USEFUL→USD oracle. A successful manipulation of one or more oracle sources could result in incorrect burn or mint quantities. Mitigations: TWAP, multi-source median, depth-weighting, governance circuit-breaker (Part D §D.3 verification layer 7).
